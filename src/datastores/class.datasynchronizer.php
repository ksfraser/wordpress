 ...
 *
 * Modified from woocommerc/src/Internal/DataStores/Orders/DataSynchronizer.php
 * 	Modified to make slightly more generic
 */
...
/**
 * This class handles the database structure creation and the data synchronization for the custom tables. Its responsibilites are:
 *
 * - Providing entry points for creating and deleting the required database tables.
 * - Synchronizing changes between the custom tables and the posts table whenever changes happen.
 */
class datasynchronizer {
	 ...
	 *
	 * @internal
	 * @param TableDataStore $data_store The data store to use.
	 * @param DatabaseUtil         $database_util The database util class to use.
	 */
	final public function init( TableDataStore $data_store, DatabaseUtil $database_util ) {
